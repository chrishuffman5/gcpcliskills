...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/dataplex/entry-groups/add-iam-policy-binding)

---
### `gcloud dataplex entry-groups create`
...
| `--display-name` | DISPLAY_NAME |  | Display name of the Entry Group. |
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/dataplex/entry-groups/create)
...
| `--etag` | ETAG |  | etag for the Entry Group you want to delete. |
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/dataplex/entry-groups/delete)

---
### `gcloud dataplex entry-groups describe`
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/dataplex/entry-groups/describe)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/dataplex/entry-groups/get-iam-policy)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/dataplex/entry-groups/list)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/dataplex/entry-groups/remove-iam-policy-binding)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/dataplex/entry-groups/set-iam-policy)
...
| `--description` | DESCRIPTION |  | Description of the Entry Group. |
| `--display-name` | DISPLAY_NAME |  | Display name of the Entry Group. |
| `--etag` | ETAG |  | etag value for particular Entry Group. |
| `--labels` | [KEY=VALUE,...] |  | List of label KEY=VALUE pairs to add. Keys must start with a lowercase character and contain only hyphens (-), underscores (_), lowercase characters, and numbers. Values must contain only hyphens (-), underscores (_), lowercase characters, and numbers. |
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/dataplex/entry-groups/update)
