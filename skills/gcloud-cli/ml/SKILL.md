...
name: gcloud-ml
description: >-
  Cloud ML APIs (Natural Language, Speech-to-Text, Video Intelligence, Vision) via gcloud (`gcloud ml`). Use Google Cloud machine learning capabilities — language, speech, video, vision.
---
