...
name: gcloud-compute
description: >-
  Compute Engine via gcloud (`gcloud compute`). Create and manipulate Compute Engine resources — accelerator-types, addresses, advice, backend-buckets, backend-services, commitments, diagnose, disk-types.
---
