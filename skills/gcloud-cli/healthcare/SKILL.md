---
name: gcloud-healthcare
description: >-
  Cloud Healthcare API via gcloud (`gcloud healthcare`). Manage Cloud Healthcare resources — consent-stores, datasets, dicom-stores, fhir-stores, hl7v2-stores, operations.
---
