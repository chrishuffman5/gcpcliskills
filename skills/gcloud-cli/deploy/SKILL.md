...
name: gcloud-deploy
description: >-
  Google Cloud Deploy via gcloud (`gcloud deploy`). Create and manage Cloud Deploy resources — automation-runs, automations, custom-target-types, delivery-pipelines, deploy-policies, job-runs, releases, rollouts.
---
