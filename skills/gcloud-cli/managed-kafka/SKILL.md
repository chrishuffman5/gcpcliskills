---
name: gcloud-managed-kafka
description: >-
  Managed Service for Apache Kafka via gcloud (`gcloud managed-kafka`). Administer Managed Service for Apache Kafka clusters, topics, and consumer groups — acls, clusters, connect-clusters, connectors, consumer-groups, operations, topics.
---
