---
name: gcloud-memorystore
description: >-
  Memorystore for Valkey via gcloud (`gcloud memorystore`). Manage Memorystore resources — backup-collections, instances, locations, operations.
---
