---
name: gcloud-audit-manager
description: >-
  Audit Manager via gcloud (`gcloud audit-manager`). Enroll resources, audit workloads and generate reports — audit-reports, audit-scopes, enrollments, operations.
---
