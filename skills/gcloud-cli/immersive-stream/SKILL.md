---
name: gcloud-immersive-stream
description: >-
  Immersive Stream for XR via gcloud (`gcloud immersive-stream`). ⚠️ removed from the GA and beta reference as of SDK ~575 (mid-2026); present in SDK 552 and earlier — xr.
---
