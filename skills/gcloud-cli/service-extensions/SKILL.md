---
name: gcloud-service-extensions
description: >-
  Service Extensions via gcloud (`gcloud service-extensions`). Manage Service Extensions resources — authz-extensions, lb-edge-extensions, lb-route-extensions, lb-traffic-extensions, wasm-plugin-versions, wasm-plugins.
---
