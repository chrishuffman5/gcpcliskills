---
name: gcloud-model-armor
description: >-
  Model Armor via gcloud (`gcloud model-armor`). Model Armor is a service offering LLM-agnostic security and AI safety measures to mitigate risks associated with large language models (LLMs) — floorsettings, templates.
---
