...
name: gcloud-storage
description: >-
  Cloud Storage via gcloud (`gcloud storage`). Create and manage Cloud Storage buckets and objects — batch-operations, buckets, folders, hmac, insights, intelligence-configs, managed-folders, objects.
---
