---
name: gcloud-datastream
description: >-
  Datastream via gcloud (`gcloud datastream`). Manage Cloud Datastream resources — connection-profiles, locations, objects, operations, private-connections, routes, streams.
---
