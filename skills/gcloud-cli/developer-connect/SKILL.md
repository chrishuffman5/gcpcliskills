---
name: gcloud-developer-connect
description: >-
  Developer Connect via gcloud (`gcloud developer-connect`). Manage Developer Connect resources — connections, insights-configs, operations.
---
