...
**Synopsis:**
```
gcloud lustre operations cancel (OPERATION : --location=LOCATION)
    [GCLOUD_WIDE_FLAG ...]
```
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/lustre/operations/cancel)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/lustre/operations/delete)
...
**Synopsis:**
```
gcloud lustre operations describe (OPERATION : --location=LOCATION)
    [GCLOUD_WIDE_FLAG ...]
```
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/lustre/operations/describe)
...
**Synopsis:**
```
gcloud lustre operations list --location=LOCATION [--filter=EXPRESSION]
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/lustre/operations/list)
...
**Synopsis:**
```
gcloud lustre operations wait (OPERATION : --location=LOCATION)
    [GCLOUD_WIDE_FLAG ...]
```
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/lustre/operations/wait)
