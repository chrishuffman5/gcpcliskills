---
name: gcloud-infra-manager
description: >-
  Infrastructure Manager via gcloud (`gcloud infra-manager`). Manage Infra Manager resources — automigrationconfig, deployments, previews, resource-changes, resource-drifts, resources, revisions, terraform-versions.
---
