...
run:
    ...
    $ gcloud container fleet create --display-name=my-fleet \
        --project=example-foo-bar-1
```

[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/create)
...
**Synopsis:**
```
gcloud container fleet delete [--async] [GCLOUD_WIDE_FLAG ...]
```
...
To delete a fleet in project example-foo-bar-1, run:
    ...
    $ gcloud container fleet delete --project=example-foo-bar-1
```

[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/delete)
...
**Synopsis:**
```
gcloud container fleet describe [GCLOUD_WIDE_FLAG ...]
```
...
To print metadata for the fleet in project example-foo-bar-1, run:
    ...
    $ gcloud container fleet describe --project=example-foo-bar-1
```

[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/describe)
...
**Synopsis:**
```
gcloud container fleet list [--organization=ORGANIZATION_ID]
...
The following command lists fleets in organization 12345:
    ...
    $ gcloud container fleet list --organization=12345
```

[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/list)
...
updated-name, run:
    ...
    $ gcloud container fleet update --display-name=updated-name \
        --project=example-foo-bar-1
```

[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/update)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/cloudrun/apply)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/cloudrun/describe)
...
**Synopsis:**
```
gcloud container fleet cloudrun disable [--force] [GCLOUD_WIDE_FLAG ...]
```
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/cloudrun/disable)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/cloudrun/enable)
...
| `--upstream-fleet` | UPSTREAM_FLEET |  | The upstream fleet. GKE will finish upgrades on the upstream fleet before applying the same upgrades to the current fleet. To configure the upstream fleet, run: $ gcloud container fleet clusterupgrade create \ --upstream-fleet={upstream_fleet} |
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/clusterupgrade/create)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/clusterupgrade/describe)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/clusterupgrade/update)

---

## `gcloud container fleet config-management` — use the Config Management feature
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/config-management/describe)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/config-management/disable)

---

## `gcloud container fleet dataplane-v2-encryption` — manage Dataplane V2 Encryption Feature
### `gcloud container fleet dataplane-v2-encryption describe`
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/dataplane-v2-encryption/describe)

---
### `gcloud container fleet dataplane-v2-encryption disable`
...
**Synopsis:**
```
gcloud container fleet dataplane-v2-encryption disable [--force]
    [GCLOUD_WIDE_FLAG ...]
```
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/dataplane-v2-encryption/disable)

---
### `gcloud container fleet dataplane-v2-encryption enable`
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/dataplane-v2-encryption/enable)
...
**Synopsis:**
```
gcloud container fleet features list [--location=LOCATION]
    [--filter=EXPRESSION] [--limit=LIMIT] [--page-size=PAGE_SIZE]
    [--sort-by=[FIELD,...]] [--uri] [GCLOUD_WIDE_FLAG ...]
```
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/features/list)
...
**Synopsis:**
```
gcloud container fleet fleetobservability describe [GCLOUD_WIDE_FLAG ...]
```
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/fleetobservability/describe)
...
**Synopsis:**
```
gcloud container fleet fleetobservability disable [--force]
    [GCLOUD_WIDE_FLAG ...]
```
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/fleetobservability/disable)
...
**Synopsis:**
```
gcloud container fleet fleetobservability enable [GCLOUD_WIDE_FLAG ...]
```
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/fleetobservability/enable)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/fleetobservability/update)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/identity-service/apply)
...
| Flag | Value | Default | Description |
|------|-------|---------|-------------|
| `--fleet-default-member-config` |  |  | If specified, deletes the default membership configuration present in your fleet. To delete the default membership configuration present in your fleet, run: $ gcloud container fleet identity-service delete \ --fleet-default-member-config |
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/identity-service/delete)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/identity-service/describe)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/identity-service/disable)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/identity-service/enable)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/ingress/describe)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/ingress/disable)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/ingress/enable)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/ingress/update)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/memberships/delete)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/memberships/describe)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/memberships/generate-gateway-rbac)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/memberships/get-credentials)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/memberships/list)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/memberships/register)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/memberships/unregister)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/memberships/update)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/memberships/bindings/create)
...
MEMBERSHIP_NAME for a global membership:
    ...
    $ gcloud container fleet memberships bindings delete BINDING_NAME \
        --membership=MEMBERSHIP_NAME
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/memberships/bindings/delete)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/memberships/bindings/describe)
...
**Synopsis:**
```
gcloud container fleet memberships bindings list --membership=MEMBERSHIP
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/memberships/bindings/list)

---
### `gcloud container fleet memberships bindings update`
...
the active project:
    ...
    $ gcloud container fleet memberships bindings update BINDING_NAME \
        --membership=MEMBERSHIP_NAME
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/memberships/bindings/update)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/memberships/support-access/describe)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/memberships/support-access/disable)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/memberships/support-access/enable)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/memberships/support-access/get-yaml)
...
**Synopsis:**
```
gcloud container fleet mesh describe [GCLOUD_WIDE_FLAG ...]
```
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/mesh/describe)
...
| Flag | Value | Default | Description |
|------|-------|---------|-------------|
| `--fleet-default-member-config` |  |  | If specified, deletes the default membership configuration present in your fleet. To delete the fleet-level default Membership configuration present in your fleet, run: $ gcloud container fleet mesh disable --fleet-default-member-config |
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/mesh/disable)
...
| Flag | Value | Default | Description |
|------|-------|---------|-------------|
| `--fleet-default-member-config` | FLEET_DEFAULT_MEMBER_CONFIG |  | The path to a service-mesh.yaml configuration file. To enable the Service Mesh Feature with a fleet-level default membership configuration, run: $ gcloud container fleet mesh enable \ --fleet-default-member-config=/path/to/service-mesh.yaml |
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/mesh/enable)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/mesh/update)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/multi-cluster-services/describe)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/multi-cluster-services/disable)
...
**Synopsis:**
```
gcloud container fleet multi-cluster-services enable [GCLOUD_WIDE_FLAG ...]
```
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/multi-cluster-services/enable)
...
To describe a long-running operation in location us-west1, run:
    ...
    $ gcloud container fleet operations describe OPERATION \
        --location=us-west1
```

[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/operations/describe)
...
**Synopsis:**
```
gcloud container fleet operations list [--location=LOCATION; default="-"]
    [--filter=EXPRESSION] [--limit=LIMIT] [--page-size=PAGE_SIZE]
    [--sort-by=[FIELD,...]] [--uri] [GCLOUD_WIDE_FLAG ...]
```
...
To list all operations in location us-west1, run:
    ...
    $ gcloud container fleet operations list --location=us-west1
```

[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/operations/list)
...
To wait for an operation in location us-west1 to complete, run:
    ...
    $ gcloud container fleet operations wait OPERATION \
        --location=us-west1
```

[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/operations/wait)

---

## `gcloud container fleet packages` — manage Fleet Packages resources
...
**Synopsis:**
```
gcloud container fleet packages create NAME --source=SOURCE
...
To create Fleet Package cert-manager-app, run:
    ...
    $ gcloud container fleet packages create cert-manager-app \
         --source=source.yaml
```

[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/packages/create)
...
To delete Fleet Package cert-manager-app in us-central1, run:
    ...
    $ gcloud container fleet packages delete cert-manager-app \
         --location=us-central1
```

[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/packages/delete)
...
To view Fleet Package cert-manager-app in us-central1, run:
    ...
    $ gcloud container fleet packages describe cert-manager-app \
         --location=us-central1
```

[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/packages/describe)
...
**Synopsis:**
```
gcloud container fleet packages list [--location=LOCATION]
    [--filter=EXPRESSION] [--limit=LIMIT] [--page-size=PAGE_SIZE]
    [--sort-by=[FIELD,...]] [--uri] [GCLOUD_WIDE_FLAG ...]
```
...
To list all Fleet Packages in us-central1, run:
    ...
    $ gcloud container fleet packages list --location=us-central1
```

[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/packages/list)
...
To update Fleet Package cert-manager-app, run:
    ...
    $ gcloud container fleet packages update cert-manager-app \
         --source=my_source.yaml
```

[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/packages/update)

---

## `gcloud container fleet packages resource-bundles` — commands for managing Package Rollouts Resource Bundles
...
**Synopsis:**
```
gcloud container fleet packages resource-bundles create NAME
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/packages/resource-bundles/create)
...
**Synopsis:**
```
gcloud container fleet packages resource-bundles delete NAME [--force]
    [--location=LOCATION] [GCLOUD_WIDE_FLAG ...]
```
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/packages/resource-bundles/delete)
...
**Synopsis:**
```
gcloud container fleet packages resource-bundles describe NAME
    [--location=LOCATION] [GCLOUD_WIDE_FLAG ...]
```
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/packages/resource-bundles/describe)
...
**Synopsis:**
```
gcloud container fleet packages resource-bundles list [--location=LOCATION]
    [--filter=EXPRESSION] [--limit=LIMIT] [--page-size=PAGE_SIZE]
    [--sort-by=[FIELD,...]] [--uri] [GCLOUD_WIDE_FLAG ...]
```
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/packages/resource-bundles/list)
...
**Synopsis:**
```
gcloud container fleet packages resource-bundles update NAME
    [--description=DESCRIPTION] [--location=LOCATION]
    [GCLOUD_WIDE_FLAG ...]
```
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/packages/resource-bundles/update)

---

## `gcloud container fleet packages resource-bundles releases` — commands for managing Package Rollouts Releases
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/packages/resource-bundles/releases/create)
...
**Synopsis:**
```
gcloud container fleet packages resource-bundles releases delete RELEASE
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/packages/resource-bundles/releases/delete)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/packages/resource-bundles/releases/describe)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/packages/resource-bundles/releases/list)
...
**Synopsis:**
```
gcloud container fleet packages resource-bundles releases update RELEASE
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/packages/resource-bundles/releases/update)

---

## `gcloud container fleet packages rollouts` — commands for managing Rollouts
...
To abort Rollout 20240318 for cert-manager-app in us-central1, run:
    ...
    $ gcloud container fleet packages rollouts abort 20240318 \
         --fleet-package=cert-manager-app --location=us-central1
```

[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/packages/rollouts/abort)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/packages/rollouts/describe)
...
**Synopsis:**
```
gcloud container fleet packages rollouts list --fleet-package=FLEET_PACKAGE
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/packages/rollouts/list)
...
To resume Rollout 20240318 for cert-manager-app in us-central1, run:
    ...
    $ gcloud container fleet packages rollouts resume 20240318 \
         --fleet-package=cert-manager-app --location=us-central1
```

[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/packages/rollouts/resume)
...
To suspend Rollout 20240318 for cert-manager-app in us-central1, run:
    ...
    $ gcloud container fleet packages rollouts suspend 20240318 \
         --fleet-package=cert-manager-app --location=us-central1
```

[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/packages/rollouts/suspend)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/policycontroller/describe)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/policycontroller/detach)
...
| Flag | Value | Default | Description |
|------|-------|---------|-------------|
| `--fleet-default-member-config` |  |  | _[At most one of these can be specified:]_ Removes the fleet default configuration for policy controller. Memberships configured with the fleet default will maintain their current configuration. $ gcloud container fleet policycontroller disable \ --fleet-default-member-config |
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/policycontroller/disable)
...
| `--no-fleet-default-member-config` |  |  | _[At most one of these can be specified:]_ Removes the fleet default configuration for policy controller. Memberships configured with the fleet default will maintain their current configuration. $ gcloud container fleet policycontroller enable \ --no-fleet-default-member-config |
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/policycontroller/enable)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/policycontroller/suspend)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/policycontroller/update)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/policycontroller/content/bundles/remove)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/policycontroller/content/bundles/set)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/policycontroller/content/templates/disable)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/policycontroller/content/templates/enable)
...
**Synopsis:**
```
gcloud container fleet policycontroller deployment remove DEPLOYMENT
...
To remove a memory limit:
    ...
    $ gcloud container fleet policycontroller deployment remove audit \
        memory-limit
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/policycontroller/deployment/remove)
...
**Synopsis:**
```
gcloud container fleet policycontroller deployment set DEPLOYMENT PROPERTY
    VALUE [--effect=EFFECT]
    [--all-memberships
      | [--memberships=[MEMBERSHIPS,...] : --location=LOCATION]]
    [GCLOUD_WIDE_FLAG ...]
...
To set the replica count for a component:
    ...
    $ gcloud container fleet policycontroller deployment set admission \
        replica-count 3
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/policycontroller/deployment/set)

---

## `gcloud container fleet rbacrolebindingactuation` — manage RbacRoleBinding Actuation
### `gcloud container fleet rbacrolebindingactuation describe`
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/rbacrolebindingactuation/describe)

---
### `gcloud container fleet rbacrolebindingactuation update`
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/rbacrolebindingactuation/update)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/scopes/add-iam-policy-binding)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/scopes/create)

---
### `gcloud container fleet scopes delete`
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/scopes/delete)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/scopes/describe)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/scopes/get-iam-policy)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/scopes/list)

---
### `gcloud container fleet scopes list-memberships`
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/scopes/list-memberships)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/scopes/remove-iam-policy-binding)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/scopes/update)

---

## `gcloud container fleet scopes namespaces` — fleet namespaces are the fleet equivalent of k8s cluster namespaces
### `gcloud container fleet scopes namespaces create`
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/scopes/namespaces/create)

---
### `gcloud container fleet scopes namespaces delete`
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/scopes/namespaces/delete)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/scopes/namespaces/describe)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/scopes/namespaces/get-credentials)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/scopes/namespaces/list)

---
### `gcloud container fleet scopes namespaces update`
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/scopes/namespaces/update)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/scopes/rbacrolebindings/create)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/scopes/rbacrolebindings/delete)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/scopes/rbacrolebindings/describe)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/scopes/rbacrolebindings/list)
...
[Official reference](https://cloud.google.com/sdk/gcloud/reference/container/fleet/scopes/rbacrolebindings/update)
