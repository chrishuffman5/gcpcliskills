---
name: gcloud-network-connectivity
description: >-
  Network Connectivity Center via gcloud (`gcloud network-connectivity`). Manage Network Connectivity resources — hubs, internal-ranges, locations, multicloud-data-transfer-configs, multicloud-data-transfer-supported-services, operations, policy-based-routes, regional-endpoints.
---
