...
**Synopsis:**
```
gcloud ai operations describe (OPERATION : --region=REGION) [--index=INDEX]
    [--index-endpoint=INDEX_ENDPOINT] [GCLOUD_WIDE_FLAG ...]
```

**Positional arguments:**
```
Operation resource - The ID of the operation. The arguments in this group
